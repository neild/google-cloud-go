...
func (bytesCodec) Name() string {
	// I haven't attempted to trace exactly what's going on here, but if this isn't "",
	// then gRPC sets the content-subtype of the call to this value and we get errors.
	return ""
}
